...
Only the *secondary* gutter keys are set — the primary `editorGutter.addedBackground`
/ `modifiedBackground` / `deletedBackground` keys stay untouched, since Git's own
quick-diff provider uses those for your uncommitted changes.
